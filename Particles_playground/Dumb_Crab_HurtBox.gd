...
func take_damage(string_atk_type, int_damage_take):
	print("On HurtBox, child of Dumb_Crab, func take_damge, atk_type: " + str(string_atk_type) + ", int_damage_take: " + str(int_damage_take))

func _on_HurtBox_area_entered(area):
	if (area.is_in_group("HitBox")):
		print("On HurtBox, child of Dumb_Crab, HitBox area entered, THAT HURTS!... Area is: " + str(area.name))
